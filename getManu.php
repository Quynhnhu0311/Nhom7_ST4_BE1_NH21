						...
						<ul class="breadcrumb-tree">
							...
							<?php 
								if(isset($_GET['manu_id'])):
									...
									$getNameByManu = $manufacture->getNameByManu($manu_id);
									foreach($getNameByManu as $value):
							?>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="products.php?id_sp=<?php echo $value['id']; ?>&type_id=<?php echo $value['type_id']; ?>"><?php echo $value['name'] ?></a></h3>
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="getProtype.php?type_id=<?php echo $value['type_id']; ?>&id=<?php echo $value['id']?>">add to cart</a></button>
									</div>
								</div>
							</div>
							<!-- /product -->
